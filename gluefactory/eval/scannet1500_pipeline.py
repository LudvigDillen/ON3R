...
class ScanNet1500TuplesPipeline(EvalPipeline):
    default_conf = {
        "data": {
            "name": "image_tuples",
            "pairs": "scannet1500/calibrated_tuples.txt",
            "root": "scannet1500/",  # This is correct as this is just a folder with images for the scenes
