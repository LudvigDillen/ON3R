...
Example:
python -m gluefactory.eval.megadepth1500 --conf gluefactory/configs/superpoint+lightglue_megadepth_tuples.yaml \
    --checkpoint outputs/training/sp+lg_megadepth_tuples/checkpoint_best.tar \
