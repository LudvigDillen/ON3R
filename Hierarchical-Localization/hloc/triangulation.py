...
def geometric_verification(
    ...
    logger.info(
        ...
        np.mean(inlier_ratios) * 100 if inlier_ratios else 0,
        np.median(inlier_ratios) * 100 if inlier_ratios else 0,
        np.min(inlier_ratios) * 100 if inlier_ratios else 0,
        np.max(inlier_ratios) * 100 if inlier_ratios else 0,
    )
